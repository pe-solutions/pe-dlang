...
| [37](../pe-0037/source/app.d) | Truncatable Primes | Sieve to 1 M; `isRightTrunc` strips last digit repeatedly; `isLeftTrunc` computes pow10 then strips leading digit via `%`; breaks after exactly 11 found |
